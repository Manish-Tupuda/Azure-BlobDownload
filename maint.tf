...
data "archive_file" "file_function_app" {
  type        = "zip"
  source_dir  = "C:/Users/Quadrant/OneDrive - Quadrant Resource LLC/Documents/sample/Project10/Function/bin/Debug/netcoreapp3.1/publish"
  output_path = "C:/Users/Quadrant/OneDrive - Quadrant Resource LLC/Documents/sample/Project10/Function/bin/Debug/netcoreapp3.1/publish/blob.zip"
}
resource "azurerm_storage_blob" "appcode" {
  name = "blobdownload.zip"
  storage_account_name = azurerm_storage_account.inbox.name
  storage_container_name = azurerm_storage_container.storagecontainer.name
  type = "Block"
  source = "C:/Users/Quadrant/OneDrive - Quadrant Resource LLC/Documents/sample/Project10/Function/bin/Debug/netcoreapp3.1/publish/blob.zip"
}
...
resource "azurerm_function_app" "fsn" {
  name                       = "ManishBlobDownloadFunction"
  location                   = "East Us"
  resource_group_name        = "woordurff_Sawyer"
